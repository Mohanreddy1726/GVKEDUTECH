...
export const metadata = {
  title: "Best Study Abroad Consultancy in Nalgonda | MBBS & Masters Abroad",
  description: "Looking for the best study abroad consultancy in Nalgonda? GVK EduTech offers expert guidance for MBBS and Masters abroad admissions in Nalgonda.",
  keywords: "study abroad consultancy nalgonda, best abroad consultancy nalgonda, overseas education consultants nalgonda, mbbs abroad consultancy nalgonda",
};
...
const faqs = [
  { q: "Why choose GVK EduTech in Nalgonda?", a: "15+ years experience placing 5,000+ students abroad." },
...
const office = {
  ...
  address: "Ground Floor, Nalgonda, Telangana",
  phones: ["+91 9966112050", "+91 8886669981"],
  email: "info@gvkedutech.com",
  mapLink: "https://goo.gl/maps/nalgonda",
  image: "https://ik.imagekit.io/abhobz66j/GVK%20Images/nalgonda-nagarjuna-sagar.jpg",
...
export default function NalgondaPage() {
  return (
    <PageLayout>
      {pageStyles}
      <PageHeader title="Best Study Abroad Consultancy in Nalgonda" subtitle="Your trusted partner for MBBS and Masters abroad" breadcrumb="Branches / Nalgonda" />
      <section className="py-16" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: T.navyMid }}>Best Study Abroad Consultancy in Nalgonda</h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-8">
              ...
              <a href="tel:+919966112050" className="px-6 py-3 rounded-xl font-semibold text-sm border" style={{ borderColor: T.surfaceAlt, color: T.navyMid }}>Call: +91 9966112050</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold" style={{ color: T.navyMid }}>GVK EduTech Nalgonda Office</h2></div>
          <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image src={office.image} alt="GVK EduTech Nalgonda" fill className="object-cover" />
            ...
            <div className="space-y-6">
              <div><h3 className="text-2xl font-bold mb-4" style={{ color: T.navyMid }}>GVK EduTech Nalgonda</h3><div className="flex items-start gap-3"><MapPin className="w-5 h-5 mt-0.5" style={{ color: T.red }} /><p className="text-sm" style={{ color: T.muted }}>{office.address}</p></div></div>
      ...
      <BranchGallery
        items={galleryImages}
        title="nalgonda Gallery"
        subtitle="Photos from our nalgonda office, events, and student success stories"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { city: "Kerala", flag: "in" },
            ].filter(b => b.city.toLowerCase() !== "nalgonda").map((branch) => (
      ...
      <section className="py-16" style={{ background: `linear-gradient(135deg, ${T.navy} 0%, #1E3558 100%)` }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="tel:+919966112050" className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm border border-white/20 text-white"><Phone className="w-4 h-4" /> Call Now</a>
          </div>
        </div>
      </section>
    </PageLayout>

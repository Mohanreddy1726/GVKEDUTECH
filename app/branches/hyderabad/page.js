...
export const metadata = {
  title: "Best Study Abroad Consultancy in Hyderabad | MBBS & Masters Abroad",
  description: "Looking for the best study abroad consultancy in Hyderabad? GVK EduTech offers expert guidance for MBBS and Masters abroad admissions, visas and scholarships.",
  keywords: "study abroad consultancy hyderabad, best abroad consultancy hyderabad, overseas education consultants hyderabad, mbbs abroad consultancy hyderabad, study abroad consultants hyderabad, foreign education consultants hyderabad, masters abroad consultancy hyderabad, study visa consultants hyderabad, education consultants hyderabad",
};
...
const faqs = [
  { q: "Why choose GVK EduTech for study abroad consultancy in Hyderabad?", a: "GVK EduTech is a trusted name with 15+ years of experience placing 5,000+ students abroad. Our Hyderabad office provides personalized counseling, free visa guidance, and end-to-end support for MBBS and Masters programs." },
  { q: "What services does your Hyderabad consultancy offer?", a: "We offer university selection, admission assistance, visa guidance, scholarship support, pre-departure briefings, and post-arrival support for students seeking MBBS and Masters abroad." },
  { q: "How much does study abroad consultancy cost in Hyderabad?", a: "GVK EduTech offers free initial counseling. Our comprehensive packages are transparent with no hidden costs. We also help students find scholarships to reduce financial burden." },
...
export default function HyderabadPage() {
  return (
    <PageLayout>
      ...
      <PageHeader
        title="Best Study Abroad Consultancy in Hyderabad"
        subtitle="Your trusted partner for MBBS and Masters abroad"
        breadcrumb="Branches / Hyderabad"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: T.navyMid }}>
              Best Study Abroad Consultancy in Hyderabad
            </h1>
            <p className="text-lg leading-relaxed" style={{ color: T.muted }}>
              Looking for the <strong>best abroad consultancy in Hyderabad</strong>? GVK EduTech is your trusted partner for pursuing MBBS and Masters abroad. With over 15 years of experience and 5,000+ successful placements, we provide expert guidance for <strong>overseas education consultants in Hyderabad</strong>. Our team offers comprehensive support for MBBS abroad, study visa consultants, and masters programs in top destinations like UK, USA, Australia, Canada, and more.
            </p>
            <div className="flex flex-wrap gap-4 justify-center mt-8">
              ...
              <a href="tel:+919010060000" className="px-6 py-3 rounded-xl font-semibold text-sm border" style={{ borderColor: T.surfaceAlt, color: T.navyMid }}>
                Call: +91 9010060000
              </a>
            </div>
          </div>
      ...
      <section className="py-20" style={{ background: T.white }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3" style={{ color: T.navyMid }}>Study Abroad Programs Offered in Hyderabad</h2>
            <p className="max-w-2xl mx-auto" style={{ color: T.muted }}>Explore our comprehensive range of MBBS and Masters programs offered through our Hyderabad consultancy</p>
          </div>
      ...
      <section className="py-20" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3" style={{ color: T.navyMid }}>Popular Destinations for Hyderabad Students</h2>
            <p className="max-w-2xl mx-auto" style={{ color: T.muted }}>Top study abroad destinations chosen by students from Hyderabad</p>
          </div>
      ...
      <section className="py-20" style={{ background: T.white }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto" style={{ color: T.muted }}>Comprehensive study abroad consultancy services for Hyderabad students</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="py-20" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3" style={{ color: T.navyMid }}>GVK EduTech Hyderabad Office</h2>
            <p className="max-w-2xl mx-auto" style={{ color: T.muted }}>Visit our head office for free counseling and personalized guidance</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
            {/* Image */}
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image src={office.image} alt="GVK EduTech Hyderabad" fill className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
              <div className="absolute bottom-6 left-6">
                <span className="px-3 py-1 text-xs font-bold rounded-full" style={{ background: T.red, color: T.white }}>Head Office</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold mb-4" style={{ color: T.navyMid }}>GVK EduTech Hyderabad</h3>
      ...
      <section className="py-20" style={{ background: T.white }}>
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto" style={{ color: T.muted }}>Common questions about study abroad consultancy in Hyderabad</p>
          </div>
      ...
      <BranchGallery
        items={galleryImages}
        title="hyderabad Gallery"
        subtitle="Photos from our hyderabad office, events, and student success stories"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { city: "Kerala", flag: "in" },
            ].filter(b => b.city.toLowerCase() !== "hyderabad").map((branch) => (
      ...
      <section className="py-16" style={{ background: `linear-gradient(135deg, ${T.navy} 0%, #1E3558 100%)` }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 mb-8 max-w-xl mx-auto">Book your free counseling session at our Hyderabad office and get expert guidance for your MBBS or Masters abroad</p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="tel:+919010060000" className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm border border-white/20 text-white">

...
export const metadata = {
  title: "Best Study Abroad Consultancy in Nizamabad | MBBS & Masters Abroad",
  description: "Looking for the best study abroad consultancy in Nizamabad? GVK EduTech offers expert guidance for MBBS and Masters abroad admissions, visas and scholarships.",
  keywords: "study abroad consultancy nizamabad, best abroad consultancy nizamabad, overseas education consultants nizamabad, mbbs abroad consultancy nizamabad, study abroad consultants nizamabad, foreign education consultants nizamabad, masters abroad consultancy nizamabad",
};
...
const office = {
  ...
  image: "https://ik.imagekit.io/abhobz66j/GVK%20Images/image_2026-08-22_111508580.png",
...
export default function NizamabadPage() {
  return (
    <PageLayout>
      {pageStyles}
      <PageHeader title="Best Study Abroad Consultancy in Nizamabad" subtitle="Your trusted partner for MBBS and Masters abroad" breadcrumb="Branches / Nizamabad" />
      <section className="py-16" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: T.navyMid }}>Best Study Abroad Consultancy in Nizamabad</h1>
      ...
      <section className="py-20" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold" style={{ color: T.navyMid }}>GVK EduTech Nizamabad Office</h2></div>
          <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="relative h-[350px] rounded-2xl overflow-hidden">
              <Image src={office.image} alt="GVK EduTech Nizamabad" fill className="object-cover" />
      ...
      <BranchGallery
        items={galleryImages}
        title="nizamabad Gallery"
        subtitle="Photos from our nizamabad office, events, and student success stories"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { city: "Mahabubnagar", flag: "in" }, { city: "Kakinada", flag: "in" }, { city: "Kerala", flag: "in" },
            ].filter(b => b.city.toLowerCase() !== "nizamabad").map((branch) => (

...
export const metadata = {
  title: "Best Study Abroad Consultancy in Vijayawada | MBBS & Masters Abroad",
  description: "Looking for the best study abroad consultancy in Vijayawada? GVK EduTech offers expert guidance for MBBS and Masters abroad in Vijayawada.",
  keywords: "study abroad consultancy vijayawada, best abroad consultancy vijayawada",
};
...
const office = {
  ...
  image: "https://ik.imagekit.io/abhobz66j/GVK%20Images/vijayawada-kanaka-durga-temple.jpg",
...
export default function VijayawadaPage() {
  return (
    <PageLayout>
      {pageStyles}
      <PageHeader title="Best Study Abroad Consultancy in Vijayawada" subtitle="Your trusted partner for MBBS and Masters abroad" breadcrumb="Branches / Vijayawada" />
      <section className="py-16" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: T.navyMid }}>Best Study Abroad Consultancy in Vijayawada</h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-8">
              ...
              <a href="tel:+918886661875" className="px-6 py-3 rounded-xl font-semibold text-sm border" style={{ borderColor: T.surfaceAlt, color: T.navyMid }}>Call: +91 8886661875</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20" style={{ background: T.surface }}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold" style={{ color: T.navyMid }}>GVK EduTech Vijayawada Office</h2></div>
          <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
            <div className="relative h-[350px] rounded-2xl overflow-hidden">
              <Image src={office.image} alt="GVK EduTech Vijayawada" fill className="object-cover" />
      ...
      <BranchGallery
        items={galleryImages}
        title="vijayawada Gallery"
        subtitle="Photos from our vijayawada office, events, and student success stories"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { city: "Kerala", flag: "in" },
            ].filter(b => b.city.toLowerCase() !== "vijayawada").map((branch) => (
      ...
      <section className="py-16" style={{ background: `linear-gradient(135deg, ${T.navy} 0%, #1E3558 100%)` }}>
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="px-6 py-3 rounded-xl font-semibold text-sm" style={{ background: T.red, color: T.white }}>Book Free Counseling</Link>
            <a href="tel:+918886661875" className="px-6 py-3 rounded-xl font-semibold text-sm border border-white/20 text-white">Call Now</a>
          </div>
        </div>
      </section>
    </PageLayout>

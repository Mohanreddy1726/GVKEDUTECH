...
import { LogOut, Users, Calculator, GraduationCap, FileText, RefreshCw, Phone, Mail, MessageCircle } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const tabs = [
    ...
    { id: "apply", label: "Apply Form", icon: FileText, count: data.applySubmissions.length },
  ];

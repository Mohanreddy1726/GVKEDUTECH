...
const faqs = [
  {
    question: "Is Samarkand State Medical University NMC approved?",
    answer:
      "Yes, Samarkand State Medical University is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at Samarkand State Medical University?",
    answer:
      "The MBBS program at SSMU is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training in affiliated hospitals.",
  },
  {
    question: "Is NEET required for admission?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including SSMU.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Students are allowed to work part-time in certain jobs. However, the course is demanding and we recommend focusing on studies.",
  },
  {
    question: "What is the total cost of MBBS at SSMU?",
    answer:
      "The total cost including tuition, hostel, and living expenses is approximately USD 35,000–40,000 for 6 years (INR 30–35 lakhs).",
  },
  {
    question: "How is the food and accommodation?",
    answer:
      "SSMU provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after SSMU?",
    answer:
      "Yes, SSMU degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from SSMU within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
  ...
  },
  {
    step: 5,
    title: "Book Flights",
    desc: "Book flights to Samarkand — GVK EduTech provides full travel support",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const whyChoose = [
  {
    ...
    desc: "Founded in 1930 — one of Uzbekistan's oldest and most respected medical universities",
    icon: Star,
  },
  {
    title: "Affordable Total Cost",
    desc: "Complete MBBS (6 years) at approx. INR 30–35 lakhs — among the most affordable in Central Asia",
    icon: IndianRupee,
  },
  {
  ...
  },
  {
    ...
    desc: "Located in historic Samarkand — a safe and culturally rich city",
    icon: CheckCircle,
  },
  {
  ...
  },
  {
    ...
    desc: "Reach Samarkand via direct flights from major Indian cities",
    icon: ArrowRight,
  },
];

export default function SamarkandStateMedicalUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Samarkand State Medical University — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 1930 · Samarkand, Uzbekistan
              </p>
              <ColorfulHeading
                text="Samarkand State Medical University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Samarkand State Medical University (SSMU) is one of the oldest and
                most prestigious medical universities in Central Asia. Located in the
                historic city of Samarkand, it is the top choice for Indian students
                seeking quality MBBS education abroad at highly affordable fees.
              </p>
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  ...
                  alt="Samarkand State Medical University campus"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { label: "NMC", sub: "WDOMS & FAIMER Registered" },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, SSMU checks every
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                SSMU's on-campus hostels are safe, comfortable, and designed with
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Samarkand is one of the oldest cities in Central Asia, known for its
                rich history, stunning architecture, and welcoming people. It offers
                a safe, affordable, and culturally enriching backdrop for six
                transformative years of study.
              </p>
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at SSMU"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Samarkand State Medical University
          </h2>

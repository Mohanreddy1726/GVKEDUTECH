...
const faqs = [
  {
    question: "Is Caucasus University NMC approved?",
    answer:
      "Yes, Caucasus University is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at Caucasus University?",
    answer:
      "The MBBS program at Caucasus University is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training.",
  },
  {
    question: "Is NEET required for admission to Caucasus University?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including Caucasus University.",
  },
  {
    question: "What is the medium of instruction at Caucasus University?",
    answer:
  ...
  {
    question: "Can I work while studying at Caucasus University?",
    answer:
  ...
  {
    question: "What is the total cost of MBBS at Caucasus University?",
    answer:
  ...
  {
    question: "How is the food and accommodation at Caucasus University?",
    answer:
      "Caucasus University provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after Caucasus University?",
    answer:
      "Yes, Caucasus University degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from Caucasus University within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
...
const documents = [
  ...
  "Admission Letter (Caucasus University)",
];
...
const whyChoose = [
  {
    ...
    desc: "Established with international standards — modern curriculum aligned with global medical practices",
    icon: Star,
  },
  {
    title: "Affordable Total Cost",
    desc: "Complete MBBS (6 years) at approx. INR 25–28 lakhs — among the most cost-effective in Georgia",
    icon: IndianRupee,
  },
  {
...
export default function CaucasusUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Caucasus University — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                One of Georgia's leading private medical universities, Caucasus University
                offers world-class MBBS education with modern infrastructure and
                internationally recognized degrees — making it a top choice for Indian
                students seeking quality medical education abroad.
              </p>
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose Caucasus University"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, Caucasus University
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Caucasus University's on-campus hostels are safe, comfortable, and designed
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at Caucasus University"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Caucasus University
          </h2>

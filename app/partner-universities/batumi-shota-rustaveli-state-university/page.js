...
const faqs = [
  {
    question: "Is Batumi Shota Rustaveli State University NMC approved?",
    answer:
      "Yes, BSU is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at BSU?",
    answer:
      "The MBBS program at BSU is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training in affiliated hospitals.",
  },
  {
    question: "Is NEET required for admission?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including BSU.",
  },
  {
  ...
  {
    question: "What is the total cost of MBBS at BSU?",
    answer:
  ...
  },
  {
    ...
    answer:
      "BSU provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after BSU?",
    answer:
      "Yes, BSU degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from BSU within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
  ...
  },
  {
    step: 5,
    title: "Book Flights",
    desc: "Book flights to Batumi — GVK EduTech provides full travel support",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const whyChoose = [
  {
    ...
    desc: "Founded in 1945 — one of Georgia's oldest and most respected medical institutions",
    icon: Star,
  },
  {
  ...
  {
    title: "Coastal City Advantage",
    desc: "Study in beautiful Batumi — a modern Black Sea coastal city",
    icon: MapPin,
  },
];

export default function BatumiShotaRustaveliStateUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Batumi Shota Rustaveli State University — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 1945 · Batumi, Georgia
              </p>
              <ColorfulHeading
                text="Batumi Shota Rustaveli State University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Batumi Shota Rustaveli State University (BSU) is one of the most
                prestigious medical universities in Georgia, offering quality MBBS
                education at highly affordable fees. Located in the beautiful
                coastal city of Batumi on the Black Sea, it provides an ideal
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  ...
                  alt="Batumi Shota Rustaveli State University campus"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { label: "#851", sub: "Asia Ranking · Times Higher Education" },
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose BSU"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, BSU checks
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Batumi Shota Rustaveli State University is globally recognised and
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                BSU's on-campus hostels are safe, comfortable, and designed
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                hospitality. Batumi, a beautiful coastal city on the Black Sea,
                offers a safe, affordable, and culturally rich backdrop for six
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at BSU"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Batumi Shota Rustaveli State University
          </h2>

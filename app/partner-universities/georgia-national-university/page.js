...
const faqs = [
  {
    question: "Is Georgia National University NMC approved?",
    answer:
      "Yes. Georgia National University is recognised by the National Medical Commission (NMC) of India. Indian graduates are eligible to appear for FMGE / NEXT and practise medicine in India after returning.",
  },
  {
    question: "What is the duration of the MBBS program at Georgia National University?",
    answer:
      "The MBBS program at Georgia National University is 6 years in total — 5 years of academic study followed by a 1-year clinical internship that includes hospital rotations and hands-on patient care.",
  },
  {
    question: "Is NEET required for admission to Georgia National University?",
    answer:
      "Yes. NEET-UG qualification is mandatory for all Indian students applying to any medical university abroad, including Georgia National University. A valid NEET scorecard is required at the time of admission.",
  },
  {
    question: "What is the medium of instruction at Georgia National University?",
    answer:
  ...
  {
    question: "What is the total cost of MBBS at Georgia National University?",
    answer:
      "The total cost including tuition, hostel, and living expenses is approximately USD 32,000 for the full 6-year MBBS program — roughly INR 27 lakhs, making it one of the most affordable NMC-approved options in Europe.",
  },
  {
    question: "How is the food and accommodation at Georgia National University?",
    answer:
  ...
  {
    question: "Can I pursue post-graduation abroad after graduating from Georgia National University?",
    answer:
      "Yes. The GNU degree is globally recognised and eligible for post-graduation pathways in the USA (USMLE), UK (PLAB), Germany, Australia, Canada, and several other countries, subject to clearing the respective licensing exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from Georgia National University within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
...
const documents = [
  ...
  "Admission Letter (Georgia National University)",
];
...
const whyChoose = [
  ...
  },
  {
    ...
    desc: "Complete 6-year MBBS at approx. INR 27 lakhs — among the lowest in Europe",
    icon: IndianRupee,
  },
  {
...
const worldRanking = [
  { label: "World Rank", value: "#7,800", source: "UniRank International Rankings" },
  { label: "Asia Rank", value: "#2,150", source: "Asian Universities Index" },
  { label: "Country Rank", value: "#18", source: "Georgia Higher Education Ranking" },
];

export default function GeorgiaNationalUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Georgia National University — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. ~25 Years · Tbilisi, Georgia
              </p>
              <ColorfulHeading
                text="Georgia National University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Georgia National University (GNU) is one of the fastest-growing
                private medical universities in Georgia, attracting students from
                over 40 countries. For Indian students seeking an{" "}
                <strong className="text-foreground">affordable MBBS abroad</strong>{" "}
                with globally recognised credentials, GNU offers a powerful
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                graduates of GNU are eligible to appear for FMGE / NEXT in India
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  ...
                  alt="Georgia National University campus"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { label: "#7,800", sub: "World Ranking · UniRank" },
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose Georgia National University"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, GNU checks
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Georgia National University holds a respectable position in
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-muted-foreground text-sm leading-relaxed">
              GNU is listed in the World Directory of Medical Schools (WDOMS),
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-16 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              ...
              day at Georgia National University.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Georgia National University's on-campus hostels are safe,
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at Georgia National University"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Georgia National University
          </h2>

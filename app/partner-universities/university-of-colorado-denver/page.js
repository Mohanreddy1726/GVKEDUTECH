...
const faqs = [
  {
    ...
    answer: "Yes. CU Denver is accredited by the U.S. Department of Education and recognized by professional bodies worldwide."
  },
  {
...
const admissionSteps = [
  ...
  { step: 3, title: "Apply Online", desc: "Submit application through CU Denver portal", icon: GraduationCap },
...
// Why choose Colorado Denver (placeholder highlights)
const whyChoose = [
...
const rankings = [
  ...
  { label: "CU Denver", sub: "Top 5% U.S. public universities" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Established 2020 · Denver, Colorado
              </p>
              <ColorfulHeading text="University of Colorado Denver" size="3xl" className="mb-5" />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                CU Denver offers a world‑class education recognised globally. With a strong focus on research, innovation and student support, it is a popular choice for Indian students seeking quality U.S. higher education.
              </p>
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading text="Why Indian Students Choose CU Denver" size="3xl" className="mb-4" />

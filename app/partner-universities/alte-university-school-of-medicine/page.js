...
const faqs = [
  {
    question: "Is Alte University School of Medicine NMC approved?",
    answer:
      "Yes, Alte University School of Medicine is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at Alte University?",
    answer:
      "The MBBS program at Alte University is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training in affiliated hospitals.",
  },
  {
    question: "Is NEET required for admission to Alte University?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including Alte University School of Medicine.",
  },
  {
    question: "What is the medium of instruction at Alte University?",
    answer:
      "The entire MBBS course is taught in English. However, students also learn Georgian language for clinical interactions with local patients during internship.",
  },
  {
    question: "Can I work while studying at Alte University?",
    answer:
  ...
  {
    question: "What is the total cost of MBBS at Alte University?",
    answer:
      "The total cost including tuition, hostel, and living expenses is approximately USD 42,000–48,000 for 6 years (INR 35–41 lakhs).",
  },
  {
    question: "How is the food and accommodation at Alte University?",
    answer:
      "Alte University provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after Alte University?",
    answer:
      "Yes, Alte University degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from Alte University within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
  ...
  },
  {
    step: 5,
    title: "Book Flights",
    desc: "Book flights to Tbilisi — GVK EduTech provides full travel support",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const documents = [
  ...
  "Admission Letter (Alte University)",
];
...
const whyChoose = [
  {
    title: "Modern Medical Campus",
    desc: "State-of-the-art infrastructure with advanced simulation labs and research facilities",
    icon: Star,
  },
  {
    title: "Affordable Total Cost",
    desc: "Complete MBBS (6 years) at approx. INR 35–41 lakhs — among the lowest in Europe",
    icon: IndianRupee,
  },
  {
  ...
  },
  {
    ...
    desc: "Study in Tbilisi — Georgia's vibrant capital with modern amenities and rich culture",
    icon: MapPin,
  },
];

export default function AlteUniversitySchoolOfMedicinePage() {
  return (
    <PageLayout>
      <PageHeader
        title="Alte University School of Medicine — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 2002 · Tbilisi, Georgia
              </p>
              <ColorfulHeading
                text="Alte University School of Medicine"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Alte University School of Medicine is a leading private medical university in Georgia,
                offering quality MBBS education at highly affordable fees. Located in the capital city
                of Tbilisi, it provides an ideal environment for Indian students with modern infrastructure
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  ...
                  alt="Alte University School of Medicine campus"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { label: "#900+", sub: "Asia Ranking · Times Higher Education" },
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose Alte University"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, Alte University checks
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Alte University School of Medicine is globally recognised and
              ranks among the top medical universities in Georgia and Asia.
            </p>
          </div>
            ...
            {[
              {
                metric: "#900+",
                label: "Asia Ranking",
                sub: "Times Higher Education 2025",
              },
              {
                metric: "#2500+",
                label: "World Ranking",
              ...
              {
                metric: "B++",
                label: "International Grade",
                sub: "Global Recognition",
              },
            ].map((item) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Alte University's on-campus hostels are safe, comfortable, and designed
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <ColorfulHeading
                text="Student Life in Georgia"
                size="3xl"
                className="mb-6 text-left"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Georgia blends European modernity with warm Caucasian
                hospitality. Tbilisi, the vibrant capital city, offers a safe,
                affordable, and culturally rich backdrop for six
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Historic capital with modern infrastructure and amenities",
                  "Rich history, cuisine, and weekend travel opportunities",
                  "English widely spoken in the city center",
                  "Vibrant Indian student community across Georgia",
                  "Direct flights from India to Tbilisi (4–5 hours)",
                  "Schengen visa access for European travel",
                ].map((item, i) => (
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at Alte University"
              size="3xl"
              className="mb-4"
            />
          </div>
          <div className="max-w-4xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Study alongside peers from 40+ countries",
              },
              {
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Alte University School of Medicine
          </h2>

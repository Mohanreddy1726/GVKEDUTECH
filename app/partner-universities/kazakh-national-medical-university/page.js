...
const faqs = [
  {
    question: "Is Kazakh National Medical University NMC approved?",
    answer:
      "Yes, KazNMU is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at KazNMU?",
    answer:
      "The MBBS program at KazNMU is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training in affiliated hospitals.",
  },
  {
    question: "Is NEET required for admission?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including KazNMU.",
  },
  {
    question: "What is the medium of instruction?",
    answer:
      "The entire MBBS course is taught in English. However, students also learn Kazakh/Russian language for clinical interactions with local patients.",
  },
  {
  ...
  {
    question: "What is the total cost of MBBS at KazNMU?",
    answer:
  ...
  },
  {
    ...
    answer:
      "KazNMU provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after KazNMU?",
    answer:
      "Yes, KazNMU degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from KazNMU within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
  ...
  },
  {
    ...
    desc: "Submit your Kazakh student visa application with university documents",
    icon: Globe,
  },
  {
    step: 5,
...
const whyChoose = [
  {
    ...
    desc: "Degree accepted for medical practice in India and globally",
    icon: ShieldCheck,
  },
  {
    title: "Affordable MBBS Cost",
    desc: "Complete MBBS (6 years) at approx. INR 24–30 lakhs",
    icon: IndianRupee,
  },
  {
    title: "No Donation / Capitation",
    desc: "Fully transparent admission — no hidden charges",
    icon: Star,
  },
  {
  ...
  },
  {
    ...
    desc: "Highly qualified professors with international exposure",
    icon: GraduationCap,
  },
  {
    title: "Clinical Training",
    desc: "Hands-on training in affiliated teaching hospitals from year 2",
    icon: BookOpen,
  },
  {
    title: "Safe Environment",
    desc: "Kazakhstan is welcoming and safe for international students",
    icon: CheckCircle,
  },
];

export default function KazakhNationalMedicalUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Kazakh National Medical University — MBBS 2026"
        subtitle="NMC Approved · WHO Recognised · English Medium · Affordable Fees"
        breadcrumb="Partner Universities"
        backgroundImage="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBgMPNrX5uYxtEm-lP9glyNac_rgO3hrTEVXX3hoev_ZRSZyXJs78hVT8&s=10"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 1951 · Almaty, Kazakhstan
              </p>
              <ColorfulHeading
                text="Kazakh National Medical University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Kazakh National Medical University (KazNMU) is one of Kazakhstan's
                premier medical institutions, offering high-quality MBBS education
                to Indian students at affordable costs. With state-of-the-art
                infrastructure and experienced faculty, KazNMU provides an excellent
                pathway for aspiring doctors.
              </p>
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8ExG0rYrwf3dgXGFr5u8QYZy6nKV5lGk9dS-p_AH1kw&s=10"
                  alt="Kazakh National Medical University campus"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { label: "IAU", sub: "International Association University" },
            ].map((item) => (
              <div key={item.label}>
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose KazNMU"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to excellent clinical training, KazNMU checks
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="KazNMU World Ranking"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              KazNMU maintains strong global rankings among medical universities.
            </p>
          </div>
          <div className="max-w-3xl mx-auto grid sm:grid-cols-3 gap-6">
            {[
              { rank: "#2842", source: "Webometrics World Ranking" },
              { rank: "Top 50", source: "Medical Universities in Asia" },
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              One of the most cost-effective MBBS destinations in Central Asia —
              no hidden charges, no capitation fees.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                KazNMU's on-campus hostels are safe, comfortable, and designed
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              <div className="grid grid-cols-2 gap-4">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRDMtnWW925gzUWzhS2l6Ns1xGNOnW_SQ8iPKdD33Dgw&s=10"
                  alt="Almaty city"
                  className="rounded-2xl shadow-lg w-full aspect-square object-cover"
                />
                <img
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Almaty is Kazakhstan's largest city and a hub of education and
                culture. Students enjoy a safe, affordable, and enriching
                environment with excellent infrastructure and friendly locals.
              </p>
              <ul className="space-y-3">
                {[
                  "Safe and welcoming city for international students",
                  "Low cost of living — affordable for Indian students",
                  "Modern infrastructure and amenities",
                  "Rich cultural experiences and natural beauty nearby",
                  "Indian community and Indian restaurants available",
                  "Good connectivity — flights from major Indian cities",
                ].map((item, i) => (
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at KazNMU"
              size="3xl"
              className="mb-4"
            />
          </div>
          <div className="max-w-4xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                desc: "Best value MBBS in Central Asia",
              },
              {
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Kazakh National Medical University
          </h2>

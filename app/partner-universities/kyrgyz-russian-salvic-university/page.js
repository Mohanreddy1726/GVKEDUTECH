...
const faqs = [
  {
    question: "Is Kyrgyz Russian Slavic University (KRSU) NMC approved?",
    answer:
      "Yes. Kyrgyz Russian Slavic University (KRSU) — also known as Bishkek Slavic University — is recognised by the National Medical Commission (NMC) of India and listed with the World Health Organization (WHO). Indian MBBS graduates of KRSU are eligible to appear for FMGE / NExT and practise medicine in India after clearing the required screening test.",
  },
  {
    question: "What is the duration of MBBS at Kyrgyz Russian Slavic University?",
    answer:
      "The MBBS program at KRSU runs for 6 years in total — 5 years of classroom, pre-clinical and clinical learning followed by 1 year of compulsory internship. The internship can be completed in Kyrgyzstan or in India, subject to NMC guidelines and university rules.",
  },
  {
    question: "Is NEET compulsory for MBBS admission at KRSU?",
    answer:
      "Yes. As per the NMC's latest regulations, every Indian student planning to study MBBS abroad must qualify NEET-UG in the year of admission. NEET is mandatory even for KRSU's English-medium MBBS program in Bishkek.",
  },
  {
    question: "What is the medium of instruction at Kyrgyz Russian Slavic University?",
    answer:
      "The full MBBS course at KRSU is taught in English for international students, which is why it is a preferred choice for Indian medical aspirants. Basic Russian/Kyrgyz language classes are included to help students during clinical rotations with local patients in Bishkek hospitals.",
  },
  {
    question: "What is the total MBBS fee at KRSU for Indian students?",
    answer:
      "The complete 6-year MBBS fee at Kyrgyz Russian Slavic University for Indian students is approximately USD 18,000–22,000 (around INR 15–19 lakh). This is among the most affordable NMC-approved MBBS options for Indian students and includes tuition, hostel support and basic services.",
  },
  {
    question: "How safe is Bishkek for Indian students studying at KRSU?",
    answer:
  ...
  {
    question: "Is there Indian food available at KRSU hostels?",
    answer:
      "Yes. The hostels attached to KRSU have an Indian mess run by experienced Indian cooks. Both vegetarian and non-vegetarian options are available daily, with a menu that suits Indian taste preferences — making it feel like home away from home for Indian students.",
  },
  {
    question: "Can I pursue PG (postgraduate) after MBBS from KRSU?",
    answer:
      "Absolutely. KRSU's MBBS degree is recognised globally, so graduates can apply for PG in India (after FMGE / NExT), USA (after USMLE), UK (after PLAB), Germany, Australia and other countries. Many KRSU alumni have built successful medical careers across the world.",
  },
  {
    question: "Does GVK EduTech help with the KRSU admission and visa process?",
    answer:
      "Yes. GVK EduTech is an authorised admission partner for Kyrgyz Russian Slavic University. We provide end-to-end support — from counselling, application, offer letter, fee remittance, visa filing and travel to airport pickup and on-campus orientation in Bishkek.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission / invitation letter from KRSU within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
    title: "Pay Tuition Fees",
    desc: "Remit the first-year tuition and hostel fees as per the KRSU fee structure",
    icon: IndianRupee,
  },
  {
    step: 4,
...
const documents = [
  ...
  "Admission / Invitation Letter from KRSU",
...
const whyChoose = [
  {
    ...
    desc: "Founded in 1993 under a Kyrgyz–Russian intergovernmental agreement — a modern, internationally respected university",
    icon: Star,
  },
  {
    title: "Most Affordable MBBS",
    desc: "Complete 6-year MBBS starting at approx. ₹15 lakh — among the lowest tuition fees in the world",
    icon: IndianRupee,
  },
  {
  ...
  },
  {
    ...
    desc: "Hundreds of Indian students already studying at KRSU — easy to settle in and make friends",
    icon: Users,
  },
  {
...
const advantages = [
  ...
  },
  {
    ...
    desc: "Hospital rotations begin from the 3rd year at KRSU-affiliated hospitals in Bishkek",
    icon: Building2,
  },
  {
...
const studentLife = [
  ...
  "English widely spoken on campus and around the KRSU area",
];
...
const recognitionList = [
  ...
  "Founded under the Kyrgyz–Russian bilateral cooperation agreement",
];

export default function KyrgyzRussianSlavicUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Kyrgyz Russian Slavic University (KRSU) — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-foreground mb-5">
                Kyrgyz Russian Slavic University Fees, Eligibility &amp; Admission Process 2026
              </h1>
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                The <strong className="text-foreground">Kyrgyz Russian Slavic University (KRSU)</strong>{" "}
                — popularly known as Bishkek Slavic University — is one of the most popular choices
                for Indian students pursuing affordable, NMC-approved MBBS abroad. Established in
                1993 under a Kyrgyz–Russian intergovernmental agreement, KRSU blends Russian
                academic excellence with affordable fee structures and a truly international
                campus culture.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                <strong className="text-foreground">₹15 lakh</strong>, KRSU offers Indian students
                a perfect combination of quality, affordability and global career opportunities
                — making it one of the top picks for{" "}
                <Link
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <div className="relative">
                <img
                  ...
                  alt="Kyrgyz Russian Slavic University campus in Bishkek"
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose KRSU"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From low MBBS fees to English-medium classes and a large Indian student
              community, KRSU checks every box for Indian medical aspirants.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Kyrgyz Russian Slavic University is one of the most recognised
                medical universities in Central Asia. Its MBBS degree is accepted
                by the NMC (India), WHO, FAIMER, ECFMG (USA) and several other
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="KRSU MBBS Fee Structure 2026–27"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto grid sm:grid-cols-2 gap-5">
            {[
              ...
              {
                title: "English",
                desc: "No IELTS / TOEFL required — KRSU teaches the full MBBS course in English",
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-16 text-center">
            <ColorfulHeading
              text="KRSU Admission Process for Indian Students"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              A simple, six-step journey from your application form to your first
              day at the KRSU campus in Bishkek.
            </p>
          </div>
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Documents Required for KRSU Admission"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <ColorfulHeading
                text="KRSU Hostel Facilities"
                size="3xl"
                className="mb-6 text-left"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                KRSU's on-campus hostels are designed with Indian students in mind —
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying MBBS at KRSU"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              KRSU stands out as a trusted Kyrgyz university for Indian MBBS
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Everything Indian students and parents ask about KRSU, Bishkek and
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Apply Now for MBBS at Kyrgyz Russian Slavic University
          </h2>

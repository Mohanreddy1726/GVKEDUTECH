...
/* ══════════════════════════════════════════════════════════
   KURSK STATE MEDICAL UNIVERSITY — CONTENT DATA
══════════════════════════════════════════════════════════ */

const faqs = [
  {
    question: "Is Kursk State Medical University NMC approved?",
    answer:
      "Yes. Kursk State Medical University (KSMU) is recognised by the National Medical Commission (NMC) of India and listed in the World Directory of Medical Schools (WDOMS) and FAIMER. Indian graduates are eligible to appear for FMGE / NEXT and practise medicine in India after clearing the licensing exam.",
  },
  {
    question: "What is the duration of the MBBS program at Kursk State Medical University?",
    answer:
      "The MBBS program at KSMU is 6 years — 5 years of academic study followed by 1 year of compulsory clinical internship. The medium of instruction is English for international students, with Russian language classes included from the first year to help with clinical interactions during hospital rotations.",
  },
  {
    question: "What is the total MBBS fees at Kursk State Medical University?",
    answer:
      "The total MBBS fees at KSMU for the complete 6-year program is approximately USD 24,000–28,000 — roughly ₹20–24 lakhs — including tuition, hostel and Indian mess. There is no donation or capitation fee at any stage of admission.",
  },
  {
    question: "Is NEET required for admission to Kursk State Medical University?",
    answer:
  ...
  {
    question: "What is the medium of instruction at Kursk State Medical University?",
    answer:
  ...
  {
    question: "How safe is Kursk city for Indian students?",
    answer:
      "Kursk is one of Russia's oldest, safest and most peaceful student cities, located about 530 km south of Moscow. The university offers 24/7 campus security, CCTV-monitored hostels, separate accommodation for boys and girls, and a friendly Indian student community that warmly supports newcomers.",
  },
  {
    question: "Is Indian food available in the hostel?",
    answer:
      "Yes. KSMU's hostel complex has an Indian mess run by experienced Indian cooks serving both vegetarian and non-vegetarian meals. Students also have access to a shared kitchen, common rooms and Indian grocery stores within Kursk city.",
  },
  {
    question: "Can I pursue PG (postgraduate) after graduating from Kursk State Medical University?",
    answer:
      "Absolutely. KSMU's degree is recognised across Europe, Asia and the Middle East. Graduates can apply for PG programs in the USA (after USMLE), UK (after PLAB), Germany, Australia, Canada and India (after NEXT / FMGE).",
  },
];
...
const admissionSteps = [
  ...
  {
    step: 5,
    title: "Book Flights to Kursk",
    desc: "Fly to Moscow, then take a connecting train or flight to Kursk — full travel assistance provided",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const whyChoose = [
  {
    ...
    desc: "Founded in 1935 — one of the oldest medical universities in Russia with a strong academic, research and clinical legacy",
    icon: Star,
  },
  {
  ...
  {
    title: "Safe & Peaceful Student City",
    desc: "Kursk is a calm, student-friendly city in central Russia with a growing Indian community",
    icon: MapPin,
  },
  {
...
const advantages = [
  ...
  },
  {
    ...
    desc: "Hands-on training in KSMU's multi-specialty teaching hospitals",
  },
  {
...
export default function KurskStateMedicalUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Kursk State Medical University Fees, Eligibility & Admission Process 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 1935 · Kursk, Russia
              </p>
              <ColorfulHeading
                text="Kursk State Medical University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Kursk State Medical University (KSMU) is one of the oldest and
                most respected government medical universities in Russia,
                located in the historic city of Kursk — about 530 km south of
                Moscow. Established in 1935, KSMU has trained thousands of
                doctors and is a popular destination for Indian students
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                , WHO and listed in WDOMS, KSMU graduates are eligible to
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <div className="relative">
                <img
                  ...
                  alt="Kursk State Medical University campus in Kursk, Russia"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              ...
              growing Indian student community, Kursk State Medical University
              is a smart choice for Indian medical aspirants.
            </p>
          </div>
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Kursk State Medical University — World Ranking"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              ...
              <Card className="border-2 border-accent/20 overflow-hidden">
                <CardHeader className="bg-accent/8 border-b border-accent/20 px-6 py-4">
                  <CardTitle className="text-base font-semibold text-foreground">
                    Kursk State Medical University — Tuition Fee Breakdown
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                  ...
                  <p className="text-xs text-muted-foreground px-6 py-3 border-t border-border">
                    * Exchange rate: 1 USD ≈ ₹85 (indicative). Kursk State
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-16 text-center">
            <ColorfulHeading
              text="Kursk State Medical University Admission Process"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Kursk State Medical University's on-campus hostels are safe,
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Kursk is one of Russia's oldest cities, located along the
                scenic Tuskor River in central Russia. With a relaxed pace of
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Everything Indian students ask about Kursk State Medical
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Kursk State Medical University
          </h2>

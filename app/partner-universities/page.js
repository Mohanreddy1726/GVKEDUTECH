      ...
      >
        ...
        >
          {visibleUnis.map((uni, i) => {
            ...
            const isBAU = uni.includes("BAU International University");
            const isPitt = uni.includes("University of Pittsburgh");
            ...
            if (isDTMU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/david-tvildiani-medical-university"
            ...
            if (isUMBC) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-maryland-baltimore-county"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isPitt) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-pittsburgh"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isBAU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/bau-international-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isAkaki) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/akaki-tsereteli-state-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // European University (EU) — Georgia specific page
            const isEU = uni === "European University (EU)";
            if (isEU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/european-university-georgia"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Texas at Dallas (UTD) — specific page
            const isUTD = uni === "University of Texas at Dallas";
            if (isUTD) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-texas-at-dallas"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Purdue University — specific page
            const isPurdue = uni === "Purdue University";
            if (isPurdue) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/purdue-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Colorado Boulder — specific page
            const isColoradoBoulder = uni === "University of Colorado Boulder";
            if (isColoradoBoulder) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-colorado-boulder"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            const isColoradoDenver = uni === "University of Colorado Denver";
            if (isColoradoDenver) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-colorado-denver"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // New Vision University — specific page
                ...
                if (isNewVision) {
                  return (
                    <Link
                      key={i}
                      href="/partner-universities/new-vision-university"
                      className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                    >
                      <CheckCircle
                        className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
...
if (isBIU) {
            ...
            if (isAdam) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/adam-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Kyrgyz-Russian Slavic University (KRSU / Bishkek Slavic) specific page
            const isKRSU = uni.includes("Kyrgyz-Russian Slavic University");
            if (isKRSU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/kyrgyz-russian-salvic-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // West Kazakhstan Marat Ospanov Medical University specific page
            const isWKMU = uni === "West Kazakhstan Marat Ospanov Medical University";
            if (isWKMU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/west-kazakhstan-marat-ospanov-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Dundee specific page
            const isDundee = uni === "University of Dundee";
            if (isDundee) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-dundee"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isKent) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-kent"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Bournemouth University specific page
            const isBournemouth = uni === "Bournemouth University";
            if (isBournemouth) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/bournemouth-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // IHSM (International Higher School of Medicine) — both campuses
            const isIHSM = uni === "IHSM Central Campus" || uni === "IHSM Issyk-Kul Campus";
            if (isIHSM) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/international-higher-school-of-medicine"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // ISM (International School of Medicine) — Kyrgyzstan
            const isISM = uni === "International School of Medicine";
            if (isISM) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/international-school-of-medicine"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isUCLan) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-central-lancashire"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Hull specific page
            const isHull = uni === "University of Hull";
            if (isHull) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-hull"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Lincoln specific page
            const isLincoln = uni === "University of Lincoln";
            if (isLincoln) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-lincoln"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Stirling specific page
            const isStirling = uni === "University of Stirling";
            if (isStirling) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-stirling"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Caspian International School of Medicine specific page
            const isCaspian = uni.includes("Caspian International School of Medicine");
            if (isCaspian) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/caspian-international-school-of-medicine"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Al-Farabi Kazakh National University specific page
            const isAlFarabi =
              uni === "Al-Farabi Kazakh National University" ||
              uni.includes("Al-Farabi Kazakh National University");
            if (isAlFarabi) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/al-farbi-kazakh-national-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Semey Medical University specific page
            const isSemey = uni.includes("Semey Medical University");
            if (isSemey) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/semey-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // South Kazakhstan Medical Academy (SKMA) specific page
            const isSKMA = uni.includes("South Kazakhstan Medical Academy");
            if (isSKMA) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/south-kazakhstan-medical-academy"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Caucasus International University (CIU) — Georgia specific page
            const isCIU = uni.includes("Caucasus International University");
            if (isCIU) {
              return (
                <Link
                  key={i}
            ...
            // Avicenna International Medical University specific page
            const isAvicenna = uni === "Avicenna International Medical University";
            if (isAvicenna) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/avicenna-international-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isSiberian) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/siberian-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isAltai) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/altai-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Amur State Medical Academy specific page
            const isAmur = uni === "Amur State Medical Academy";
            if (isAmur) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/amur-state-medical-academy"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Chita State Medical Academy specific page
            const isChita = uni === "Chita State Medical Academy";
            if (isChita) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/chita-state-medical-academy"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Sechenov University specific page
            const isSechenov = uni === "Sechenov University";
            if (isSechenov) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/sechenov-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // People's Friendship University (RUDN) specific page
            const isRUDN = uni.includes("People's Friendship University");
            if (isRUDN) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/peoples-friends-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Kursk State Medical University specific page
            const isKursk = uni === "Kursk State Medical University";
            if (isKursk) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/kursk-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isNWSMU) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/north-western-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Pavlov First Saint Petersburg State Medical University specific page
            const isPavlov = uni.includes("Pavlov First Saint Petersburg State Medical University");
            if (isPavlov) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/pavlov-first-saint-petersburg-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Pacific State Medical University specific page
            const isPacific = uni === "Pacific State Medical University";
            if (isPacific) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/pacific-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Lancaster University specific page
            const isLancaster = uni === "Lancaster University";
            if (isLancaster) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/lancaster-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Leicester specific page
            const isLeicester = uni === "University of Leicester";
            if (isLeicester) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-leicester"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Reading specific page
            const isReading = uni === "University of Reading";
            if (isReading) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-reading"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Salford specific page
            const isSalford = uni === "University of Salford";
            if (isSalford) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-salford"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Newcastle University specific page
            const isNewcastle = uni === "Newcastle University";
            if (isNewcastle) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/newcastle-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Essex specific page
            const isEssex = uni === "University of Essex";
            if (isEssex) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-essex"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Oxford Brookes University specific page
            const isOxfordBrookes = uni === "Oxford Brookes University";
            if (isOxfordBrookes) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/oxford-brookes-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Strathclyde specific page
            const isStrathclyde = uni === "University of Strathclyde";
            if (isStrathclyde) {
              return (
                <Link
                  key={i}
            ...
            // University of Portsmouth specific page
            const isPortsmouth = uni === "University of Portsmouth";
            if (isPortsmouth) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-portsmouth"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Derby specific page
            const isDerby = uni === "University of Derby";
            if (isDerby) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-derby"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Aberdeen specific page
            const isAberdeen = uni === "University of Aberdeen";
            if (isAberdeen) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-aberdeen"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Brunel University London specific page
            const isBrunel = uni === "Brunel University London";
            if (isBrunel) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/brunel-university-london"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // University of Huddersfield specific page
            const isHuddersfield = uni === "University of Huddersfield";
            if (isHuddersfield) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/university-of-huddersfield"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            if (isTver) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/tver-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Kemerovo State Medical University specific page
            const isKemerovo = uni === "Kemerovo State Medical University";
            if (isKemerovo) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/kemerovo-state-medical-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Middlesex University (UK) specific page
            const isMiddlesex = uni === "Middlesex University";
            if (isMiddlesex) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/middlesex-university"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"
            ...
            // Northeastern University (Boston) specific page
            const isNortheastern = uni === "Northeastern University";
            if (isNortheastern) {
              return (
                <Link
                  key={i}
                  href="/partner-universities/northeastern-university-boston"
                  className="uni-chip cursor-pointer hover:border-red-500 hover:bg-red-50"
                >
                  <CheckCircle
                    className="w-3.5 h-3.5 flex-shrink-0 mt-0.5"

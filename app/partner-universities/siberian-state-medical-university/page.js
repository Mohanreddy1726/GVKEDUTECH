...
/* ══════════════════════════════════════════════════════════
   SIBERIAN STATE MEDICAL UNIVERSITY — CONTENT DATA
══════════════════════════════════════════════════════════ */

const faqs = [
  {
    question: "Is Siberian State Medical University NMC approved?",
    answer:
      "Yes. Siberian State Medical University (SSMU) is recognised by the National Medical Commission (NMC) of India and listed in the World Directory of Medical Schools (WDOMS) and FAIMER. Indian graduates are eligible to appear for FMGE / NEXT and practise medicine in India after clearing the licensing exam.",
  },
  {
    question: "What is the duration of the MBBS program at Siberian State Medical University?",
    answer:
      "The MBBS program at SSMU is 6 years — 5 years of academic study followed by 1 year of compulsory clinical internship. The medium of instruction is English for international students, with Russian language classes included from the first year to help with clinical interactions.",
  },
  {
    question: "What is the total MBBS fees at Siberian State Medical University?",
    answer:
      "The total MBBS fees at SSMU for the complete 6-year program is approximately USD 27,000–30,000 — roughly ₹23–26 lakhs — including tuition, hostel and Indian mess. There is no donation or capitation fee at any stage of admission.",
  },
  {
    question: "Is NEET required for admission to Siberian State Medical University?",
    answer:
  ...
  {
    question: "What is the medium of instruction at Siberian State Medical University?",
    answer:
  ...
  {
    question: "How safe is Tomsk city for Indian students?",
    answer:
      "Tomsk is one of Russia's oldest and safest university cities, located in Western Siberia. The university offers 24/7 campus security, CCTV-monitored hostels, separate accommodation for boys and girls, and a supportive Indian student community that helps newcomers settle in comfortably.",
  },
  {
    question: "Is Indian food available in the hostel?",
    answer:
      "Yes. SSMU's hostel complex has an Indian mess run by experienced Indian cooks serving both vegetarian and non-vegetarian meals. Students also have access to a shared kitchen, common rooms and Indian grocery stores within Tomsk city.",
  },
  {
    question: "Can I pursue PG (postgraduate) after graduating from Siberian State Medical University?",
    answer:
...
const admissionSteps = [
  ...
  {
    step: 5,
    title: "Book Flights to Tomsk",
    desc: "Fly to Moscow, then take a domestic flight to Tomsk — full travel assistance provided",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const whyChoose = [
  {
    title: "140+ Years of Medical Excellence",
    desc: "Founded in 1878 — one of Siberia's oldest and most reputed government medical universities with a rich academic and clinical legacy",
    icon: Star,
  },
  {
    title: "Affordable Total Fees",
    desc: "Complete 6-year MBBS at approx. ₹23–26 lakhs — significantly lower than Indian private medical colleges",
    icon: IndianRupee,
  },
  {
  ...
  },
  {
    ...
    desc: "Tomsk is a peaceful, green university city with a high concentration of students from across the world",
    icon: MapPin,
  },
  {
...
const rankings = [
  ...
  { label: "1878", sub: "Year Established — 145+ Years of Legacy" },
];
...
export default function SiberianStateMedicalUniversityPage() {
  return (
    <PageLayout>
      <PageHeader
        title="Siberian State Medical University Fees, Eligibility & Admission Process 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-3">
                Est. 1878 · Tomsk, Russia
              </p>
              <ColorfulHeading
                text="Siberian State Medical University"
                size="3xl"
                className="mb-5"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Siberian State Medical University (SSMU) is a premier
                government medical university located in Tomsk, Western
                Siberia, Russia. Established in 1878, SSMU is one of the
                oldest and most respected medical institutions in Siberia and
                a top destination for Indian students seeking quality and
                affordable{" "}
                <Link
                  href="/mbbs/russia"
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <div className="relative">
                <img
                  ...
                  alt="Siberian State Medical University campus in Tomsk, Russia"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              ...
              student communities, Siberian State Medical University ticks
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Siberian State Medical University — World Ranking"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              ...
              <Card className="border-2 border-accent/20 overflow-hidden">
                <CardHeader className="bg-accent/8 border-b border-accent/20 px-6 py-4">
                  <CardTitle className="text-base font-semibold text-foreground">
                    Siberian State Medical University — Tuition Fee Breakdown
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                  ...
                  <p className="text-xs text-muted-foreground px-6 py-3 border-t border-border">
                    * Exchange rate: 1 USD ≈ ₹85 (indicative). Siberian State
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-16 text-center">
            <ColorfulHeading
              text="Siberian State Medical University Admission Process"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Siberian State Medical University's on-campus hostels are
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Tomsk is one of Russia's oldest university cities and a true
                student capital of Siberia — a peaceful, green and culturally
                rich city on the Tom River. Six years here is a truly
                transformative life experience.
              </p>
              <ul className="space-y-3">
                {[
                  "One of Russia's most renowned student cities — home to 6+ universities",
                  "Significantly lower cost of living than Moscow & St. Petersburg",
                  "Rich culture — historic wooden architecture, museums, theatres and Siberian cuisine",
                  "Beautiful Tom river, scenic landscapes and snowy Siberian winters",
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              Everything Indian students ask about Siberian State Medical
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Siberian State Medical University
          </h2>

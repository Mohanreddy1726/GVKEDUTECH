...
const faqs = [
  {
    question: "Is European University Georgia NMC approved?",
    answer:
      "Yes. European University (EU), Georgia is recognised by the National Medical Commission (NMC) of India. Indian graduates are eligible to appear for FMGE / NEXT and practise medicine in India after returning.",
  },
  {
    question: "What is the duration of the MBBS program at European University Georgia?",
    answer:
      "The MBBS program at European University is 6 years in total — 5 years of academic study followed by a 1-year clinical internship that includes hospital rotations and hands-on patient care.",
  },
  {
    question: "Is NEET required for admission to European University Georgia?",
    answer:
      "Yes. NEET-UG qualification is mandatory for all Indian students applying to any medical university abroad, including European University. A valid NEET scorecard is required at the time of admission.",
  },
  {
    question: "What is the medium of instruction at European University Georgia?",
    answer:
  ...
  {
    question: "Can I work part-time while studying MBBS in Georgia?",
    answer:
  ...
  {
    question: "What is the total cost of MBBS at European University Georgia?",
    answer:
      "The total cost including tuition, hostel, and living expenses is approximately USD 30,000 for the full 6-year MBBS program — roughly INR 25–26 lakhs, making it one of the most affordable NMC-approved options in Europe.",
  },
  {
    question: "How is the food and accommodation at European University Georgia?",
    answer:
      "The university provides well-furnished on-campus hostels with separate arrangements for boys and girls. Indian mess facilities serve vegetarian and non-vegetarian meals. Rooms include heating, Wi-Fi, laundry, and 24/7 security.",
  },
  {
    question: "Can I pursue post-graduation abroad after graduating from European University?",
    answer:
      "Yes. The European University degree is globally recognised and eligible for post-graduation pathways in the USA (USMLE), UK (PLAB), Germany, Australia, Canada, and several other countries, subject to clearing the respective licensing exams.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from European University within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
...
const documents = [
  ...
  "Admission Letter (European University)",
];
...
const whyChoose = [
  ...
  },
  {
    ...
    desc: "Complete 6-year MBBS at approx. INR 25–26 lakhs — among the lowest in Europe",
    icon: IndianRupee,
  },
  {
...
const worldRanking = [
  { label: "World Rank", value: "#8,200", source: "UniRank International Rankings" },
  { label: "Europe Rank", value: "#2,050", source: "European Universities Index" },
  { label: "Country Rank", value: "#22", source: "Georgia Higher Education Ranking" },
];

export default function EuropeanUniversityGeorgiaPage() {
  return (
    <PageLayout>
      <PageHeader
        title="European University Georgia — MBBS 2026"
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <ColorfulHeading
                text="European University Georgia"
                size="3xl"
                className="mb-5"
              />
              <h1 className="sr-only">
                European University Fees, Eligibility &amp; Admission Process 2026
              </h1>
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                European University (EU), Georgia is a leading private medical
                university in Tbilisi, attracting students from over 30 countries.
                For Indian students seeking an{" "}
                <strong className="text-foreground">affordable MBBS abroad</strong>{" "}
                with globally recognised credentials, EU offers a powerful
                combination of academic quality, modern infrastructure, and
                transparent fees.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ...
                graduates of European University are eligible to appear for
                FMGE / NEXT in India and practise medicine upon return — opening
                doors to a global medical career.
              </p>
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <div className="relative">
                <img
                  ...
                  alt="European University Georgia campus"
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose European University"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, European
              University checks every box for Indian medical aspirants.
            </p>
          </div>
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            />
            <p className="text-muted-foreground text-lg">
              European University holds a respectable position in international
              rankings and is recognised by major medical councils and
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-muted-foreground text-sm leading-relaxed">
              European University is listed in the World Directory of Medical
              Schools (WDOMS), recognised by the Educational Commission for
              Foreign Medical Graduates (ECFMG), and approved by the Foundation
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                European University's on-campus hostels are safe, comfortable,
                and thoughtfully designed for international students — from
                dedicated Indian mess options to round-the-clock security.
              </p>
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at European University"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at European University Georgia
          </h2>

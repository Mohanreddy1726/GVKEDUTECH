...
const faqs = [
  {
    question: "Is Andijan State Medical Institute NMC approved?",
    answer:
      "Yes, Andijan State Medical Institute is recognized by the National Medical Commission (NMC) of India. Indian students can appear for FMGE/NEXT after completing their MBBS degree.",
  },
  {
    question: "What is the duration of MBBS at Andijan State Medical Institute?",
    answer:
      "The MBBS program at ASMI is 6 years (5 years + 1 year internship). This includes clinical rotation and practical training in affiliated hospitals.",
  },
  {
    question: "Is NEET required for admission?",
    answer:
      "Yes, NEET-UG qualification is mandatory for Indian students seeking admission to any medical university abroad, including ASMI.",
  },
  {
  ...
  {
    question: "What is the total cost of MBBS at ASMI?",
    answer:
      "The total cost including tuition, hostel, and living expenses is approximately USD 28,000–35,000 for 6 years (INR 24–30 lakhs).",
  },
  {
    question: "How is the food and accommodation?",
    answer:
      "ASMI provides hostels with Indian mess facilities. Vegetarian and non-vegetarian Indian food is available. Rooms are furnished with necessary amenities.",
  },
  {
    question: "Can I do postgraduate in other countries after ASMI?",
    answer:
      "Yes, ASMI degree is globally recognised. Students can pursue PG in USA, UK, Germany, Australia, and other countries after clearing respective exams.",
  },
  {
    question: "Where is Andijan located?",
    answer:
      "Andijan is located in the eastern part of Uzbekistan and is the largest city in the Fergana Valley, known for its rich agricultural heritage and vibrant culture.",
  },
];
...
const admissionSteps = [
  ...
  },
  {
    ...
    desc: "Get your official admission letter from ASMI within 7–10 working days",
    icon: BookOpen,
  },
  {
    step: 3,
  ...
  },
  {
    step: 5,
    title: "Book Flights",
    desc: "Book flights to Andijan — GVK EduTech provides full travel support",
    icon: ArrowRight,
  },
  {
    step: 6,
...
const whyChoose = [
  {
    ...
    desc: "Founded in 1995 — one of Uzbekistan's premier medical universities with state-of-the-art infrastructure",
    icon: Star,
  },
  {
    title: "Affordable Total Cost",
    desc: "Complete MBBS (6 years) at approx. INR 24–30 lakhs — among the most affordable in Central Asia",
    icon: IndianRupee,
  },
  {
  ...
  },
  {
    ...
    desc: "Located in Andijan — the heart of the Fergana Valley, a safe and culturally rich region",
    icon: MapPin,
  },
  {
...
export default function AndijanStateMedicalInstitutePage() {
  return (
    <PageLayout>
      <PageHeader
        title="Andijan State Medical Institute — MBBS 2026"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Andijan State Medical Institute (ASMI) is a premier medical university
                located in the historic city of Andijan, Uzbekistan. Known for its
                excellent academic standards and affordable fee structure, ASMI is an
                excellent choice for Indian students seeking quality MBBS education abroad.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            ...
            <p className="text-muted-foreground text-lg">
              ASMI holds prestigious rankings and recognitions globally, making it a
      ...
      <section className="py-20 section-light">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Why Indian Students Choose ASMI"
              size="3xl"
              className="mb-4"
            />
            <p className="text-muted-foreground text-lg">
              From affordable tuition to a safe living environment, ASMI checks every
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="fade-up">
              ...
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                ASMI's on-campus hostels are safe, comfortable, and designed with
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              ...
              <ColorfulHeading
                text="Heart of the Fergana Valley"
                size="3xl"
                className="mb-6 text-left"
              />
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Andijan is the largest city in the Fergana Valley, a region known for its
                rich agricultural heritage, vibrant culture, and welcoming people. It offers
                a safe, affordable, and culturally enriching backdrop for six transformative
                years of study.
              </p>
      ...
      <section className="py-20 section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <ColorfulHeading
              text="Advantages of Studying at ASMI"
              size="3xl"
              className="mb-4"
            />
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-primary/80">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-primary-foreground mb-6 max-w-3xl mx-auto leading-tight">
            Begin Your MBBS Journey at Andijan State Medical Institute
          </h2>

  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <div className="relative group/whatsapp">
        ...
        {/* Tooltip with MBBS/Masters selection - show on hover */}
        <div className="absolute bottom-full right-0 mb-2 min-w-[160px] bg-foreground text-background text-sm font-medium rounded-lg shadow-xl overflow-hidden opacity-0 invisible group-hover/whatsapp:opacity-100 group-hover/whatsapp:visible transition-all duration-200">
      ...
      <div className="relative group/phone">
        ...
        {/* Tooltip with MBBS/Masters selection - show on hover */}
        <div className="absolute bottom-full right-0 mb-2 min-w-[160px] bg-foreground text-background text-sm font-medium rounded-lg shadow-xl overflow-hidden opacity-0 invisible group-hover/phone:opacity-100 group-hover/phone:visible transition-all duration-200">
          <div className="p-2 text-center border-b border-background/20 font-semibold">
            Select Program
          </div>
          <button
